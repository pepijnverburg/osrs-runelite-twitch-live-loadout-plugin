...
public enum TwitchEventSubType {
    ...
    HYPE_TRAIN_BEGIN("channel.hype_train.begin", "Start Hype Train", true, 2, HypeTrainBegin.class, (p, c, m) -> true, TwitchLiveLoadoutConfig::beginHypeTrainMessage, (plugin, config, message) -> config.beginHypeTrainMessageEnabled()),
    HYPE_TRAIN_PROGRESS("channel.hype_train.progress", "Increase Hype Train", true, 2, HypeTrainProgress.class, (p, c, m) -> true, TwitchLiveLoadoutConfig::progressHypeTrainMessage, (plugin, config, message) -> config.progressHypeTrainMessageEnabled()),
    HYPE_TRAIN_END("channel.hype_train.end", "Stop Hype Train", true, 2, HypeTrainEnd.class, (p, c, m) -> true, TwitchLiveLoadoutConfig::endHypeTrainMessage, (plugin, config, message) -> config.endHypeTrainMessageEnabled()),
